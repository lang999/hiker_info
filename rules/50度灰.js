const csdown = {
    ...
    aes: $.toString(() => {
        ...
        var lazy = $('').lazyRule(() => {
            ...
            var data0 = '{"id":"' + input + '","system_oauth_type":"pwa","system_oauth_id":"cwurLEOExkopZKbeO9F_1761007929992","system_oauth_new_id":"","system_version":"9.3.2","system_app_type":"","system_build":"","system_build_id":""}';
    ...
    search: () => {
        ...
        try {
            ...
            if ((getMyVar('搜索', 'long') == 'long') | (getMyVar('搜索', 'long') == 'small')) {
                var data0 = '{"system_version":"9.3.2","system_token":"","system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"R3O2lxhWUaSamr8m3ih_1743502699655","system_app_type":"","system_build":"","system_build_id":"","page":' + pg + ',"size":10,"limit":10,"keyword":"' + getMyVar('keyword') + '","type":"' + getMyVar('搜索', 'long') + '"}';
                ...
                var data0 = '{"system_version":"9.3.2","system_token":"","system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"R3O2lxhWUaSamr8m3ih_1743502699655","system_app_type":"","system_build":"","system_build_id":"","page":' + pg + ',"size":10,"limit":10,"word":"' + getMyVar('keyword') + '"}';
    ...
    video: () => {
        ...
        try {
            ...
            if ((getMyVar('c2', '111') == 111) | (getMyVar('c2', '111') == 222)) {
                var data0 = '{"page":"' + pg + '","_t":"1","system_oauth_type":"pwa","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"9.3.2","system_app_type":"","system_build":"","system_build_id":""}';
                ...
                if (getMyVar('c2', '111') == 3) {
                    var data0 = '{"system_version":"9.3.2","system_token":null,"system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"aaCidFG3mAldGW405wx_1743160264138","system_app_type":"","system_build":"","system_build_id":"","page":' + pg + ',"_t":1}';
                    ...
                    var data0 = '{"system_oauth_type":"pwa","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"9.3.2","system_app_type":"","system_build":"","system_build_id":"","page":"' + pg + '","tabId":"' + getMyVar('c2', '111') + '"}';
    ...
    mini: () => {
        ...
        if (storage0.getItem('small_video') == '') {
            let small_video_body = '{"system_version":"9.3.2","system_token":"","system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"R3O2lxhWUaSamr8m3ih_1743502699655","system_app_type":"","system_build":"","system_build_id":""}';
        ...
        var data0 = '{"system_version":"9.3.2","system_token":"","system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"R3O2lxhWUaSamr8m3ih_1743502699655","system_app_type":"","system_build":"","system_build_id":"","page":' + pg + ',"size":10,"limit":10,"tag":"' + getMyVar('短视频', getMyVar('mini_index')) + '"}';
    ...
    news: () => {
        ...
        if (storage0.getItem('news_' + getMyVar('社区', '0')) == '') {
            ...
            let cate_body = '{"system_version":"9.3.2","system_token":null,"system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"aaCidFG3mAldGW405wx_1743160264138","system_app_type":"","system_build":"","system_build_id":"","p_type":' + getMyVar('社区', '0') + '}';
        ...
        if (MY_PAGE == 1) {
            ...
            if (storage0.getItem('topics' + getMyVar('社区', '0') + getMyVar('社区分类' + getMyVar('社区', '0'), getMyVar('news_index_' + getMyVar('社区', '0')))) == '') {
                ...
                let topics_body = '{"system_version":"9.3.2","system_token":null,"system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"aaCidFG3mAldGW405wx_1743160264138","system_app_type":"","system_build":"","system_build_id":"","tag":"recommend","more":"no","p_type":' + getMyVar('社区', '0') + ',"p_id":' + getMyVar('社区分类' + getMyVar('社区', '0'), getMyVar('news_index_' + getMyVar('社区', '0'))) + ',"page":1,"size":10}';
        ...
        try {
            var data0 = '{"system_version":"9.3.2","system_token":null,"system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"aaCidFG3mAldGW405wx_1743160264138","system_app_type":"","system_build":"","system_build_id":"","page":' + pg + ',"tag":"' + getMyVar('社区_type', 'hot') + '","p_type":' + getMyVar('社区', '0') + ',"cate_id":' + getMyVar('社区分类' + getMyVar('社区', '0'), getMyVar('news_index_' + getMyVar('社区', '0'))) + '}';
    ...
    news_erji: () => {
        ...
        var data0 = '{"system_version":"9.3.2","system_token":null,"system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"aaCidFG3mAldGW405wx_1743160264138","system_app_type":"","system_build":"","system_build_id":"","id":"' + id + '"}';
    ...
    topic: () => {
        ...
        try {
            ...
            var data0 = '{"system_version":"9.3.2","system_token":null,"system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"aaCidFG3mAldGW405wx_1743160264138","system_app_type":"","system_build":"","system_build_id":"","page":' + pg + ',"size":12,"limit":12,"tag":"' + getMyVar('圈子', 'hot') + '","topic_id":"' + id + '"}';
    ...
    wei: () => {
        ...
        var data0 = '{"system_version":"9.3.2","system_token":"","system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"R3O2lxhWUaSamr8m3ih_1743502699655","system_app_type":"","system_build":"","system_build_id":"","page":' + pg + ',"size":10,"limit":10,"type":"' + getMyVar('微帖分类', 'new') + '"}';
        if (getMyVar('微帖', '1') == 1) {
    ...
    wei_erji: () => {
        ...
        let pg = getParam('page');
        if (MY_PAGE == 1) {
            let data0 = '{"system_version":"9.3.2","system_token":"","system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"R3O2lxhWUaSamr8m3ih_1743502699655","system_app_type":"","system_build":"","system_build_id":"","find_id":"' + id + '"}';
        ...
        let reply_body = '{"system_version":"9.3.2","system_token":"","system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"R3O2lxhWUaSamr8m3ih_1743502699655","system_app_type":"","system_build":"","system_build_id":"","page":' + pg + ',"size":10,"limit":10,"find_id":"' + id + '"}';
    ...
    vodlei: () => {
        ...
        if (storage0.getItem('cate_') == '') {
            var data0 = '{"system_oauth_type":"pwa","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"9.3.2","system_token":"","system_app_type":"","system_build":"","system_build_id":""}';
    ...
    heji: () => {
        ...
        var pg = getParam('page');
        try {
            var data0 = '{"page":"' + pg + '","sort":"new","system_oauth_type":"pwa","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"9.3.2","system_token":"","system_app_type":"","system_build":"","system_build_id":""}';
    ...
    everyday: () => {
        ...
        eval(csdown.rely(csdown.aes))
        var pg = getParam('page');
        var data0 = '{"page":"' + pg + '","system_oauth_type":"pwa","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"9.3.2","system_token":"","system_app_type":"","system_build":"","system_build_id":""}';
    ...
    erji: () => {
        ...
        try {
            ...
            if (getMyVar('video_up', '1') == 1) {
                var p0 = (pg - 1) * 50;
                var data0 = '{"size":"15","uuid":"' + id + '","lastId":"","system_oauth_type":"pwa","lastId":"' + p0 + '","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"9.3.2","system_token":"","system_app_type":"","system_build":"","system_build_id":""}';
                ...
                var data0 = '{"system_version":"9.3.2","system_token":null,"system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"aaCidFG3mAldGW405wx_1743160264138","system_app_type":"","system_build":"","system_build_id":"","page":' + pg + ',"uuid":"' + id + '"}';
                ...
                var data0 = '{"system_version":"9.3.2","system_token":null,"system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"aaCidFG3mAldGW405wx_1743160264138","system_app_type":"","system_build":"","system_build_id":"","page":' + pg + ',"size":1,"uuid":"' + id + '"}';
    ...
    erji2: () => {
        ...
        let id = MY_PARAMS.id;
        let pg = getParam('page')
        var data0 = '{"limit":"10","id":"' + id + '","page":"' + pg + '","system_oauth_type":"pwa","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"9.3.2","system_token":"","system_app_type":"","system_build":"","system_build_id":""}';
    ...
    erji3: () => {
        ...
        let id = MY_PARAMS.id;
        let pg = getParam('page');
        var data0 = '{"page":"' + pg + '","size":"15","id":"' + id + '","orderBy":"id","system_oauth_type":"pwa","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"9.3.2","system_token":"","system_app_type":"","system_build":"","system_build_id":""}';
    ...
    erji4: () => {
        ...
        let id = MY_PARAMS.id;
        let pg = getParam('page');
        var data0 = '{"id":"' + id + '","sort":"new","page":"' + pg + '","system_oauth_type":"pwa","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"9.3.2","system_app_type":"","system_build":"","system_build_id":""}';

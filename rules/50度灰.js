  ...
  search: () => {
    ...
    try {
      ...
      if ((getMyVar('搜索', 'long') == 'long') | (getMyVar('搜索', 'long') == 'small')) {
        var data0 = '{"system_version":"6.2.1","system_token":"","system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"R3O2lxhWUaSamr8m3ih_1743502699655","system_app_type":"","system_build":"","system_build_id":"","page":' + pg + ',"size":10,"limit":10,"keyword":"' + getMyVar('keyword') + '","type":"' + getMyVar('搜索', 'long') + '"}';
        ...
        var data0 = '{"system_version":"6.2.1","system_token":"","system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"R3O2lxhWUaSamr8m3ih_1743502699655","system_app_type":"","system_build":"","system_build_id":"","page":' + pg + ',"size":10,"limit":10,"word":"' + getMyVar('keyword') + '"}';
